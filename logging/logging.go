...
// LogWriter maps string values to io.Writer channels intended for logging output.
//
// This function is intended to provide a standard way of mapping environment-based
// configuration with various logging channels. An empty string will default to
...
// and if assertion is successful properly close the log file on shutdown.
